...
namespace CodeBits
{
    ...
    public static class GeoDistance
    {
            ...
            DistanceUnits units = DistanceUnits.Kilometers)
        {
            ...
            double distance =
                Math.Acos(Math.Cos(a1) * Math.Cos(b1) * Math.Cos(a2) * Math.Cos(b2) +
                    Math.Cos(a1) * Math.Sin(b1) * Math.Cos(a2) * Math.Sin(b2) + Math.Sin(a1) * Math.Sin(a2)) * DistanceConstants[units];
        ...
        private static readonly Dictionary<DistanceUnits, double> DistanceConstants = new Dictionary<DistanceUnits, double>(3) {
