...
namespace CodeBits
{
    ...
    /// </summary>
    public static partial class ByteArrayHelper
    {
        /// <summary>
        ...
        /// <returns>
        ///     <c>true</c> if the byte array is either null or empty; other <c>false</c>.
        /// </returns>
        ...
        /// <summary>
        ///     Indicates whether the specified byte array is null, does not contain any elements or
        ///     consists of only zero value items.
        /// </summary>
        /// <param name="source"> The byte array to test. </param>
        /// <returns>
        ///     <c>true</c> if the byte array is <c>null</c>, does not contain any elements or consists
        ///     exclusively of zero value items.
        /// </returns>
        ...
        ///     The optional delimiter to separate each item in the array. Default to ',' if not specified.
        /// </param>
        /// <returns>The combined string.</returns>
        /// <exception cref="ArgumentNullException">
        ///     Thrown if <paramref name="delimiter"/> is <c>null</c>.
        /// </exception>
