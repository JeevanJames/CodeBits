...
namespace CodeBits
{
    ...
    public sealed class WindowsServiceRunner
    {
        ...
        /// </typeparam>
        public WindowsServiceRunner Register<TService>() where TService : ServiceBase, new()
        {
        ...
        /// </summary>
        /// <typeparam name="TService">
        ///     The type of service to run. This type must be a subclass of ServiceBase.
        /// </typeparam>
        /// <param name="args">The arguments to pass to the service class constructor.</param>
        public WindowsServiceRunner Register<TService>(params object[] args) where TService : ServiceBase
        {
